					...
					<main className="min-h-screen bg-primary text-white relative">
						<section className="min-h-screen grid place-items-center relative">
							<Image
								...
								alt="Geeks Icon"
							/>
							<div className="p-6 sm:p-0 text-center z-1">
						...
						<section className="min-h-screen text-center mb-12">
						...
						<section className="min-h-screen text-center p-6 sm:p-0">
							<motion.h2
						...
						<section className="min-h-screen text-center mb-32 p-6 sm:p-0">
							<motion.h2
								initial={{ y: 100, opacity: 0 }}
								whileInView={{ y: 0, opacity: 1 }}
								transition={{ type: "spring", stiffness: 30 }}
						...
						<section className="min-h-screen text-center m-auto p-6 sm:p-0">
